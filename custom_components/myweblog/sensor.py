...
SENSOR_TYPES = {
    "next_booking": SensorEntityDescription(
        ...
        translation_key="sensor_next_booking",
    ),
    "yellow_tags": SensorEntityDescription(
        key="yellow_tags",
        name="Yellow Tags",
        icon="mdi:tag-outline",
        translation_key="sensor_yellow_tags",
    ...
    "red_tags": SensorEntityDescription(
        ...
        name="Red Tags",
        icon="mdi:tag",
        translation_key="sensor_red_tags",
        state_class=SensorStateClass.MEASUREMENT,
    ),
    "days_to_go": SensorEntityDescription(
        ...
        translation_key="sensor_days_to_go",
        state_class=SensorStateClass.MEASUREMENT,
    ...
    "hours_to_go": SensorEntityDescription(
        ...
        translation_key="sensor_hours_to_go",
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.DURATION,
    ...
    "airborne": SensorEntityDescription(
        ...
        name="Airborne",
        icon="mdi:airplane",
        translation_key="sensor_airborne",
    ...
    "tachometer": SensorEntityDescription(
        ...
        name="Tachometer",
        icon="mdi:counter",
        translation_key="sensor_tachometer",
        state_class=SensorStateClass.TOTAL,
        device_class=SensorDeviceClass.DURATION,
        unit_of_measurement="h",
    ),
    "tach_time": SensorEntityDescription(
        ...
        translation_key="sensor_tach_time",
        state_class=SensorStateClass.TOTAL,
        device_class=SensorDeviceClass.DURATION,
        unit_of_measurement="h",
    ),
    "landings": SensorEntityDescription(
        ...
        translation_key="sensor_landings",
        state_class=SensorStateClass.TOTAL,
    ),
